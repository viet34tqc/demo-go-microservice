...
func (x *ListTodosRequest) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
type GetTodoRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        uint64                 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	TodoId        uint64                 `protobuf:"varint,2,opt,name=todo_id,json=todoId,proto3" json:"todo_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetTodoRequest) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *GetTodoRequest) GetTodoId() uint64 {
	if x != nil {
		return x.TodoId
	}
	return 0
...
func (x *UpdateTodoRequest) GetTodoId() uint64 {
	if x != nil {
		return x.TodoId
	}
	return 0
...
func (x *DeleteTodoRequest) GetTodoId() uint64 {
	if x != nil {
		return x.TodoId
	}
	return 0
...
const file_todo_v1_todo_proto_rawDesc = "" +
	"\n" +
	"\x12todo/v1/todo.proto\x12\atodo.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xd9\x01\n" +
	"\x04Todo\x12\x0e\n" +
	...
	"\x05todos\x18\x01 \x03(\v2\r.todo.v1.TodoR\x05todos\"B\n" +
	"\x0eGetTodoRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x04R\x06userId\x12\x17\n" +
	"\atodo_id\x18\x02 \x01(\x04R\x06todoId\"\x9b\x01\n" +
	"\x11UpdateTodoRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x04R\x06userId\x12\x17\n" +
	"\atodo_id\x18\x02 \x01(\x04R\x06todoId\x12\x19\n" +
	"\x05title\x18\x03 \x01(\tH\x00R\x05title\x88\x01\x01\x12!\n" +
	"\tcompleted\x18\x04 \x01(\bH\x01R\tcompleted\x88\x01\x01B\b\n" +
	"\x06_titleB\f\n" +
	"\n" +
	"_completed\"E\n" +
	"\x11DeleteTodoRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x04R\x06userId\x12\x17\n" +
	"\atodo_id\x18\x02 \x01(\x04R\x06todoId\"1\n" +
	"\fTodoResponse\x12!\n" +
	...
	"\vTodoService\x12?\n" +
	"\n" +
	"CreateTodo\x12\x1a.todo.v1.CreateTodoRequest\x1a\x15.todo.v1.TodoResponse\x12B\n" +
	"\tListTodos\x12\x19.todo.v1.ListTodosRequest\x1a\x1a.todo.v1.ListTodosResponse\x129\n" +
	"\aGetTodo\x12\x17.todo.v1.GetTodoRequest\x1a\x15.todo.v1.TodoResponse\x12?\n" +
	"\n" +
	"UpdateTodo\x12\x1a.todo.v1.UpdateTodoRequest\x1a\x15.todo.v1.TodoResponse\x12E\n" +
	"\n" +
	"DeleteTodo\x12\x1a.todo.v1.DeleteTodoRequest\x1a\x1b.todo.v1.DeleteTodoResponseBAZ?github.com/viet34tqc/demo-go-microservice/gen/go/todo/v1;todov1b\x06proto3"
...
var file_todo_v1_todo_proto_goTypes = []any{
	...
	(*TodoResponse)(nil),          // 7: todo.v1.TodoResponse
...
var file_todo_v1_todo_proto_depIdxs = []int32{
	...
	0, // 3: todo.v1.TodoResponse.todo:type_name -> todo.v1.Todo
	1, // 4: todo.v1.TodoService.CreateTodo:input_type -> todo.v1.CreateTodoRequest
	2, // 5: todo.v1.TodoService.ListTodos:input_type -> todo.v1.ListTodosRequest
	...
	6, // 8: todo.v1.TodoService.DeleteTodo:input_type -> todo.v1.DeleteTodoRequest
	7, // 9: todo.v1.TodoService.CreateTodo:output_type -> todo.v1.TodoResponse
	3, // 10: todo.v1.TodoService.ListTodos:output_type -> todo.v1.ListTodosResponse
	7, // 11: todo.v1.TodoService.GetTodo:output_type -> todo.v1.TodoResponse
	7, // 12: todo.v1.TodoService.UpdateTodo:output_type -> todo.v1.TodoResponse
